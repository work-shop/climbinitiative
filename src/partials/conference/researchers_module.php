...
<div id="conference-researchers">
	...
	foreach( $researchers as $person ):
		...
		?>
		<div class="researcher col-xs-4 modal-toggle" data-modal-target="modal-researcher-<?php echo $person_slug; ?>" id="researcher-<?php echo $person_slug; ?>">
		...
		<div class="modal modal-person off scroll" id="modal-researcher-<?php echo $person_slug; ?>">
